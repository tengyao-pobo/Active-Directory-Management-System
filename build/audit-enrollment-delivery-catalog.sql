...
-- BEGIN generated delivery function contracts
 ('enrollment_execution.audit_execution_privileges(pg_catalog.uuid)','owner','s','','3f9aabca280ae32f9bef9fa466b7ac9c17af80c065ff1752c2f04fde848915ad','2950',ARRAY[2950,16,25,21]::oid[],ARRAY['p_environment','is_valid','diagnostic_code','profile_version']::text[],ARRAY['i','t','t','t']::"char"[],2249::oid,true),
