...
-- BEGIN generated delivery function contracts
 ('enrollment_execution.audit_execution_privileges(pg_catalog.uuid)','owner','s','','dfb6cdd268132c1bae909ddc03f6df4e3e9d9aa3f851c87ec8649c88b1497c4d','2950',ARRAY[2950,16,25,21]::oid[],ARRAY['p_environment','is_valid','diagnostic_code','profile_version']::text[],ARRAY['i','t','t','t']::"char"[],2249::oid,true),
