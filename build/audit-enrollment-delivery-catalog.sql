...
-- BEGIN generated delivery function contracts
 ('enrollment_execution.audit_execution_privileges(pg_catalog.uuid)','owner','s','','4864d776264c6e843c86237173b747ec276dc9f172d97ea180a5d03d0e5139ff','2950',ARRAY[2950,16,25,21]::oid[],ARRAY['p_environment','is_valid','diagnostic_code','profile_version']::text[],ARRAY['i','t','t','t']::"char"[],2249::oid,true),
