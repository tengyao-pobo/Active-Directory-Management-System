...
-- BEGIN generated delivery function contracts
 ('enrollment_execution.audit_execution_privileges(pg_catalog.uuid)','owner','s','','6fafcd84383218cede3dc63f7c3a8ebe85587fdda950df1cf1dc08831ed988db','2950',ARRAY[2950,16,25,21]::oid[],ARRAY['p_environment','is_valid','diagnostic_code','profile_version']::text[],ARRAY['i','t','t','t']::"char"[],2249::oid,true),
